...
var len__21393__auto___26554 = arguments.length;
var i__21394__auto___26555 = (0);
while(true){
if((i__21394__auto___26555 < len__21393__auto___26554)){
args__21400__auto__.push((arguments[i__21394__auto___26555]));

var G__26556 = (i__21394__auto___26555 + (1));
i__21394__auto___26555 = G__26556;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26553){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26553));
});
...
var vec__26560 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__26561 = cljs.core.seq.call(null,vec__26560);
var first__26562 = cljs.core.first.call(null,seq__26561);
var seq__26561__$1 = cljs.core.next.call(null,seq__26561);
var first_word = first__26562;
var words = seq__26561__$1;
...
var G__26564 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26564,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__26564;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26565_SHARP_){
if(typeof p1__26565_SHARP_ === 'string'){
return p1__26565_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26565_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1493780418020